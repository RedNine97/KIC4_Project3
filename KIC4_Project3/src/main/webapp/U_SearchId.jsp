...
<meta http-equiv="X-UA-Compatible" content="IE=edge">
  ...
  <title>아이디 찾기(U_SearchId)</title>
  <script src="https://cdn.tailwindcss.com"></script>
  <script src="https://cdn.tailwindcss.com?plugins=forms,typography,aspect-ratio,line-clamp"></script>
  <script src="https://code.jquery.com/jquery-3.3.1.js"></script>
  <script language="JavaScript" src="U_script.js?ver=2.4"></script>
</head>
<body>
    ...
    <div class="container mx-auto">
      <div class="-mx-4 flex flex-wrap">
        <div class="w-full px-4">
          <div class="relative mx-auto py-auto max-w-2xl overflow-hidden rounded-lg bg-white flex justify-center text-center align-middle flex justify-center">

	        
	        <form name="SearchId" method="post" action="U_SearchIdProc.shop">
	            ...
	            <p class="relative block text-lg mb-10 text-gray-900">회원 이메일 주소와 입력한 이메일 주소가 같아야,<br> 인증번호를 받을 수 있습니다.</p>
				...
				<div class="relative inline-flex mt-3">
				     ...
				     <button type="button" id="shIdButton" onClick="SearchCheck();" class="px-1 py-1 text-white absolute right-0.5 bottom-1 bg-blue-700 hover:bg-blue-800 
	            ...
	            <div class="px-4 py-3 text-center sm:px-6">
	            	<button type="button" class="inline-flex justify-center rounded-md border border-transparent bg-blue-700 py-2 px-6
		             ...
		             <button 
					    ...
					    onclick="searchidCheck()">다음</button>
	            </div>
			</form>
          </div>
        </div>
