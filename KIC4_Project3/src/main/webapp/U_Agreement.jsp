...
<body>
  ...
  <div class="mb-8 text-center md:mb-8" >
    <p class="text-xl font-bold my-6 md:-mt-5 -mt-3">회원 동의 약관</p>
    
    <textarea style="resize: none";" cols="61" rows="18" name="agree" spellcheck="false" class=" md:mx-8 text-left">
제 1 장 총 칙
...
제 2 장 서비스 이용계약
 ...
 제 3 조 (이용계약의 성립)
 ① 서비스 가입 신청시 본 약관을 읽고 "동의합니다" 버튼을 누르면 이 약관에 동의하는 것으로 간주됩니다. 
...
제 5 장  손해배상
 ...
 요금 등 서비스 이용으로 발생한 분쟁에 대해 소송이 제기될 경우 회사의 본사 소재지 법원을 관할법원으로 합니다.
    ...
    <button 
    class="max-h-0.5 max-w-xs mt-5 col-span-6 sm:col-span-2 bg-blue-600 inline-flex items-center justify-center rounded-full py-4 px-10 text-center text-sm font-normal text-white hover:bg-opacity-90 lg:px-10 xl:px-10"
    onclick="document.location='./U_Register.shop'">
    동의합니다
    </button>
    <button 
    class="max-h-0.5 max-w-xs mt-5 col-span-6 sm:col-span-2 bg-gray-500 inline-flex items-center justify-center rounded-full py-4 px-10 text-center text-sm font-normal text-white hover:bg-opacity-90 lg:px-10 xl:px-10"
